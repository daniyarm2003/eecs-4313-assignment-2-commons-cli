...
public class AmbiguousOptionException_ESTest extends AmbiguousOptionException_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        ambiguousOptionException0 = new AmbiguousOptionException("u'~^.", (Collection<String>) null);
  ...
  public void test1()  throws Throwable  {
      ...
      AmbiguousOptionException ambiguousOptionException0 = new AmbiguousOptionException("ZV+$$c,9A2%HI[13", set0);
      Collection<String> collection0 = ambiguousOptionException0.getMatchingOptions();
      assertFalse(collection0.contains("ZV+$$c,9A2%HI[13"));
  }
}

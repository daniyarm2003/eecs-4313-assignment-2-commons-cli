...
public class Util_ESTest extends Util_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      String string0 = Util.stripLeadingHyphens("-5rj3H7@:Rx1n");
      assertEquals("5rj3H7@:Rx1n", string0);
  }
  ...
  public void test05()  throws Throwable  {
      String string0 = Util.stripLeadingAndTrailingQuotes("\"_-\"");
      assertEquals("_-", string0);
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      String string0 = Util.stripLeadingAndTrailingQuotes("\"f!");
  ...
  public void test09()  throws Throwable  {
      String string0 = Util.stripLeadingAndTrailingQuotes("--'%Dvkn1\"+");
      assertEquals("--'%Dvkn1\"+", string0);
  }
